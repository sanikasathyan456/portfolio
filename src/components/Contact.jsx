...
function Contact(){
    return(
      <section id="contact" className="min-h-screen bg-gradient-to-br from-[#141414] via-[#1a1a1a] to-[#262626] text-slate-100 py-16 px-6 flex flex-col items-center justify-center">
        ...
        <div className="bg-neutral-900/60 backdrop-blur-md border border-neutral-800 rounded-2xl p-8 max-w-md w-full space-y-6 transition-all duration-300 shadow-sm hover:shadow-xl hover:shadow-black/50 relative overflow-hidden group">
          {/* Top decorative line */}
          ...
          <div className="flex items-center gap-4 p-3 rounded-xl hover:bg-neutral-800/40 transition-colors">
            <div className="text-2xl bg-blue-950/40 text-blue-400 w-12 h-12 flex items-center justify-center rounded-xl font-bold border border-blue-900/30">
              ✉️
            </div>
            <div>
